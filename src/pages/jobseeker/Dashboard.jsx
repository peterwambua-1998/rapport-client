        ...
        <div className="lg:col-span-3 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-7 gap-6">
              ...
              <CardContent className="pl-4 pr-4 text-sm">
                <div className="space-y-4">
                  ...
                  <div className="border border-slate-300 px-4 py-2 rounded bg-[#acc8ac]">
                    <p>
                      <span className="text-lg font-semibold">
                        {profileData.interviewsCompleted}{" "}
                      </span>{" "}
                  ...
                  <div className="border border-slate-300 px-4 py-2 rounded bg-[#acc8ac]">
                    <p>
                      <span className="text-lg font-semibold">
                        {profileData.challengesCompleted}{" "}
                      </span>{" "}
            ...
            <div className="md:col-span-5">
              <div>
                <div
                  className="relative h-[40vh] sm:h-[50vh] md:h-[57vh] rounded-t-lg bg-gray-200"
                  style={{
                ...
                >
                  <Dialog>
                    ...
                    <DialogContent className="max-w-[90vw] md:max-w-[70vw] lg:max-w-[70vw]">
                      <DialogHeader>
                ...
                <div className="p-4 bg-black/50 rounded-b-lg">
                  <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between text-sm text-white">
          ...
          <Card className="bg-[#c3dac4] border border-slate-300">
            <CardContent className="p-6">
              <h2 className="text-lg font-semibold mb-4 text-[#2b4033]">
                About Me
              </h2>
              ...
              <CardContent className="p-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    <h3 className="font-medium text-[#2b4033]">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="space-y-2">
                      {profileData.aiRecommendations.map(
              ...
              <CardContent className="p-6">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <a
                      href={profileData.registrationData.linkedIn}
                  ...
                  <div>
                    ...
                    <a
                      href={profileData.registrationData.website}
                      className="font-medium text-green-700 hover:text-green-800"
                    >
                  ...
                  <div>
                    ...
                    <a
                      href={profileData.registrationData.github}
                      className="font-medium text-green-700 hover:text-green-800"
                    >
                      {profileData.registrationData.github}
                    </a>
                  </div>
                </div>
              </CardContent>
          ...
          <Tabs
            defaultValue="soft"
            className="w-full bg-[#c3dac4] border border-slate-300 p-6 rounded-lg"
          >
            <TabsList>
              ...
              <div className="">
                ...
                <div className="space-y-4 ">
                  {profileData.experience.map((exp, index) => (
                    <div
                      className="border-l-4 border-[#94a49c] pl-4"
                      key={index}
                    >
          ...
          <Card className="bg-[#c3dac4] border border-slate-300">
            <CardContent className="p-6">
              <div className="flex items-center justify-between mb-6">
                <h2 className="text-lg font-semibold text-[#2b4033]">
                  Video Testimonials
                </h2>
                <Button
                  ...
                  size="sm"
                >
                  <CirclePlus strokeWidth={2.5} /> Request new
                </Button>
              </div>
        ...
        <div className="space-y-6">
          ...
          <Card className="bg-[#c3dac4] border border-slate-500">
            <CardContent className="p-6">
              <div className="flex flex-col items-center">
                ...
                />
                <h2 className="text-xl font-semibold text-[#2b4033]">
                  {profileData.name}
                </h2>
                ...
                <div className="w-full mt-6 space-y-3">
                  <Button
                    ...
                    className="bg-[#dce2d4] hover:bg-[#c2c8bb] text-black w-full flex items-center justify-center"
                  >
          ...
          <Card className="border border-slate-500">
            <CardHeader className="flex flex-row items-center justify-between">
              ...
              <Button variant="link" className="text-sm text-[#2b4033]">
                <ArrowRight /> View all
              </Button>
            </CardHeader>
            <CardContent>
              {profileData.upComingInterviews.length == 0 ? (
                ...
                <div className="space-y-4">
                  {profileData.upComingInterviews.map((interview, index) => (
                    <div
                      key={index}
                      className="border px-2 py-2 rounded bg-[#c3dac4]"
                    >
