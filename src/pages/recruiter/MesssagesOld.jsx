...
const Messages = () => {
  ...
  //     const recruiterId = conversation.jobSeeker.id;
  ...
  //         id: recruiterId,
  //         name: `${conversation.jobSeeker.name}`,
  //         role: conversation.jobSeeker.JobSeeker.professionalTitle || "Unknown",
  ...
  //         isUser: msg.isUser === conversation.recruiterId,
  //         msg: msg.message,
  //       })),
  //     });
